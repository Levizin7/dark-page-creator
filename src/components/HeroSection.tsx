...
const HeroSection = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Waves - inverted, hanging from hero into next section */}
      <div className="overflow-hidden pointer-events-none -mt-1" style={{ transform: "scaleY(-1)" }}>
        <svg className="w-full h-[60px] block" viewBox="0 0 1440 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="wave1Grad" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="hsl(217 60% 28%)" stopOpacity="0.9" />
              <stop offset="50%" stopColor="hsl(217 60% 28%)" stopOpacity="1" />
              <stop offset="100%" stopColor="hsl(217 60% 28%)" stopOpacity="0.9" />
            </linearGradient>
            <linearGradient id="wave2Grad" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="hsl(217 60% 28%)" stopOpacity="0.6" />
              <stop offset="100%" stopColor="hsl(217 60% 28%)" stopOpacity="0.7" />
            </linearGradient>
          </defs>
          <motion.path
            animate={{
              d: [
                "M0,40L48,45C96,50,192,60,288,58C384,56,480,42,576,38C672,34,768,42,864,46C960,50,1056,50,1152,46C1248,42,1344,34,1392,30L1440,26L1440,0L0,0Z",
                "M0,30L48,35C96,40,192,50,288,54C384,58,480,58,576,50C672,42,768,30,864,26C960,22,1056,30,1152,38C1248,46,1344,50,1392,52L1440,54L1440,0L0,0Z",
                "M0,40L48,45C96,50,192,60,288,58C384,56,480,42,576,38C672,34,768,42,864,46C960,50,1056,50,1152,46C1248,42,1344,34,1392,30L1440,26L1440,0L0,0Z",
              ],
            }}
          ...
          <motion.path
            animate={{
              d: [
                "M0,60L48,56C96,52,192,44,288,44C384,44,480,52,576,56C672,60,768,60,864,54C960,48,1056,38,1152,38C1248,38,1344,48,1392,54L1440,60L1440,0L0,0Z",
                "M0,50L48,54C96,58,192,66,288,64C384,62,480,50,576,46C672,42,768,46,864,52C960,58,1056,66,1152,64C1248,62,1344,50,1392,44L1440,38L1440,0L0,0Z",
                "M0,60L48,56C96,52,192,44,288,44C384,44,480,52,576,56C672,60,768,60,864,54C960,48,1056,38,1152,38C1248,38,1344,48,1392,54L1440,60L1440,0L0,0Z",
              ],
            }}
          ...
          <motion.path
            animate={{
              d: [
                "M0,80L60,76C120,72,240,64,360,62C480,60,600,66,720,72C840,78,960,82,1080,78C1200,74,1320,64,1380,60L1440,56L1440,0L0,0Z",
                "M0,70L60,74C120,78,240,86,360,86C480,86,600,78,720,72C840,66,960,62,1080,62C1200,62,1320,66,1380,68L1440,70L1440,0L0,0Z",
                "M0,80L60,76C120,72,240,64,360,62C480,60,600,66,720,72C840,78,960,82,1080,78C1200,74,1320,64,1380,60L1440,56L1440,0L0,0Z",
              ],
            }}
